...
export default function Button({ 
  ...
  const modernClasses = variant === 'primary' 
    ? "bg-sky-100 text-black hover:bg-sky-200 shadow-sm rounded-lg font-bold border border-sky-300" 
    : "bg-white text-black border border-gray-300 hover:bg-gray-50 rounded-lg";

  const classicClasses = variant === 'primary'
    ? "bg-sky-100 text-black border-2 border-black hover:bg-sky-200 rounded-none shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-[2px] active:translate-y-[2px] font-bold"
